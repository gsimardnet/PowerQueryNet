...
Installer : [PowerQueryNet.msi](https://github.com/gsimardnet/PowerQueryNet/releases/download/v1.0.1/PowerQueryNet.msi)

Samples : [PowerQueryNet.Samples.zip](https://github.com/gsimardnet/PowerQueryNet/releases/download/v1.0.1/PowerQueryNet.Samples.zip)
